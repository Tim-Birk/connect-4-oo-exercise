...
class Game {
  ...
  makeHtmlBoard() {
    this.removePreviousHtmlBoard();
    this.addNewHtmlBoard();
  ...
  checkForWin() {
    // make arrow function to retain current "this"
    const _win = (cells) => {
...
form.addEventListener("submit", (e) => {
  ...
  new Game(6, 7, new Player(1, player1Color), new Player(2, player2Color));
});
